...
namespace Scanner
{
    ...
    public class PortScanner
    {
        ...
        public static int amountOfPorts = 0;
        ...
        public PortScanner(string host, int portStart, int portStop)
        {
            ...
            PortScanner.amountOfPorts = portStop - portStart;

        }

        private string[] result = new string[PortScanner.amountOfPorts];
        ...
        {          
            ...
            while ((port = portList.getNext()) != -1)
            {
                ...
                result[cnt] = "TCP Port " + port + " is open on host " + host;
                cnt++;
            }
        }
    }
